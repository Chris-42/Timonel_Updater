...
#define LOW_TML_ADDR 1      // Lowest allowed TWI address for Timonel devices
#define HIG_TML_ADDR 0x7F   // Highest allowed TWI address for Timonel devices
...
#define DLY_SET_ADDR 100  //100 Delay after setting a memory address
#define DLY_RETURN 100    //100 Delay before return control to caller
...
#define DLY_PKT_REQUEST 150  //150 Delay between data packet requests
...
#define DLY_PKT_SEND 10   //10 Delay after sending a data packet
#define DLY_FLASH_PG 100  //100 Delay to allow memory page flashing
